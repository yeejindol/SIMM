-- 1. Borrar tablas (de asociaciones a entidades simples)
...
-- 2. Borrar tipos (de hijos a padres)
...
-- 3. Definición de Tipos (con NOT FINAL para permitir herencia)
...
-- 5. Carga de Datos (Usando constructores para subtipos)
